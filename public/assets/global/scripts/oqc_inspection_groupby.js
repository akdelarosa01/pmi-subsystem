                ...
                gp1 += "<div class='panel panel-info'>";
                    ...
                    gp1 += "<div id='grp_val"+x+"' class='panel-collapse collapse' aria-expanded='false'>";
                        gp1 += "<div class='panel-body table-responsive' id='child"+x+"'>";
                            gp1 += "<table style='font-size:9px;width:100%' class='table table-condensed table-bordered'>";
                                gp1 += "<thead>";
                                    gp1 += "<tr>";
                                        gp1 += "<td></td>";
                                        gp1 += "<td></td>";
    ...
    for(var x=0;x<req.length;x++){
        ...
        var gp1 = "";
            ...
            for(y=0;y<req[x].length;y++){
                    ...
                    gp1 += "</h4>";
                    gp1 += "</div>";
                    gp1 += "<div id='grp_val"+idc+"' class='panel-collapse collapse in' aria-expanded='false'>";
