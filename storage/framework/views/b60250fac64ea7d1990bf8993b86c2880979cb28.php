...
$(function() {
    ...
    $('#btn_pdf').on('click', function() {
        ...
        var url = "<?php echo e(url('/packingMOLDINGprintreport?datefrom=')); ?>" + datefrom + "&dateto=" + dateto+ "&pono=" + pono+ "&groupfield=" + groupfield+ "&groupvalue=" + groupvalue+ "&status=" + status;
    ...
    $('#btn_excel').on('click', function() {
        ...
        var url = "<?php echo e(url('/packingMOLDINGprintreportexcel?datefrom=')); ?>" + datefrom + "&dateto=" + dateto+ "&pono=" + pono+ "&groupfield=" + groupfield+ "&groupvalue=" + groupvalue+ "&status=" + status;
        window.location.href= url;
        $('#hd_search_from').val("");
        $('#hd_search_to').val("");
        $('#hd_partcode').val("");
