...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/typeahead/typeahead.css')); ?>">
...
<body class="page-md page-header-fixed page-quick-sidebar-over-content page-full-width">
	...
	<script src="<?php echo e(asset('assets/global/plugins/bootstrap-pwstrength/pwstrength-bootstrap.min.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/jquery-tags-input/jquery.tagsinput.min.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/bootstrap-filestyle/bootstrap-filestyle.min.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/bootstrap-touchspin/bootstrap.touchspin.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/bootstrap-fixed-table/table-fixed-header.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/bootstrap-select/bootstrap-select.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/typeahead/handlebars.min.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/plugins/typeahead/typeahead.bundle.min.js')); ?>" type="text/javascript"></script>
	...
	<script src="<?php echo e(asset('assets/global/scripts/productline.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/scripts/orderdatacheck.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('assets/global/scripts/mra.js')); ?>" type="text/javascript"></script>
