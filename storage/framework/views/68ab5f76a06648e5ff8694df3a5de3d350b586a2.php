...
<?php echo $__env->make('includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <?php foreach($userProgramAccess as $access): ?>
    <?php if($access->program_code == Config::get('constants.MODULE_CODE_WBS')): ?>
              ...
              <div class="scroller" style="height: 700px;">
                <table class="table table-striped table-bordered table-hover table-responsive" id="tbl_iqc" style="font-size:10px">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td style="text-align: center; background-color: <?php echo $statuscolor; ?>"><input type="checkbox" class="checkboxes input-sm chk_item" name="chk_item" value="<?php echo e($iqcsdata->item .'|'. $iqcsdata->wbs_mr_id .'|'. $iqcsdata->lot_no); ?>"/></td>
...
<!--                         <div class="form-group">
                          ...
                          <div class="col-sm-7">
                            <input type="text" class="form-control input-sm" id="invoicenomdl" name="invoiceno"  value="<?php //if(strlen($selectedinvoiceno) > 0){ echo $selectedinvoiceno;} ?>">
                          </div>
                        </div> -->
                      </div>
                    </div>
                  ...
                  <div class="modal-footer">
                    <button type="submit" onclick="filter();" data-dismiss="modal" class="btn btn-success">OK</button>
...
<!--                                 <div class="form-group">
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" onclick="updateStatus();" data-dismiss="modal" class="btn btn-success">OK</button>
                            <button type="button" data-dismiss="modal" class="btn btn-danger">Close</button>
                          </div>
                        </div>
                      </div>
