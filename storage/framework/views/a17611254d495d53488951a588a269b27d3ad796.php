...
<div id="inspection_modal" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog gray-gallery modal-lg">
        <div class="modal-content ">
            ...
            <form class=form-horizontal method="post" action="<?php echo e(url('/packinginspection/save-inspection')); ?>" id="frm_inspection">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm clear" id="po_num" name="po_num">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control input-sm clear date-picker" type="text" value="" name="date_inspected" id="date_inspected"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control input-sm clear date-picker" type="text" value="" name="shipment_date" id="shipment_date"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm clear" id="device_name" name="device_name" readonly />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm clear show-tick" name="packing_type" id="packing_type">
                                        <option value=""></option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm clear" name="unit_condition" id="unit_condition">
                                        <option value=""></option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm clear" name="packing_operator" id="packing_operator">
                                        <option value=""></option>
                                    </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm clear" name="packing_code_series" id="packing_code_series">
                                        <option value=""></option>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm clear" id="carton_num" name="carton_num">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm clear" id="packing_code" name="packing_code">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control input-sm clear" name="judgement" id="judgement">
                                        <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control input-sm clear" id="total_qty" name="total_qty" readonly>
