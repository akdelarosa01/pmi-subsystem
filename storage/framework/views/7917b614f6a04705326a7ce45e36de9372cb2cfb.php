																	...
																	<table class="table table-bordered table-fixedheader table-striped" id="tbl_batch" style="font-size:10px">
																		...
																		<tbody id="table_body" >
																			...
																			<tr id="tr_batch_item<?php echo e($piddata->id); ?>">
																				...
																				<td style="width:5.14%" class="batch_item<?php echo e($piddata->id); ?> inputBatchId" name="inputId">
																					<?php echo e($piddata->id); ?>

																				</td>
																				<td style="width:7.14%" class="batch_item<?php echo e($piddata->id); ?> inputItemNo" name="inputItemNo">
																					<?php echo e($piddata->item); ?>

																				</td>
																				<td style="width:11.14%" class="batch_item<?php echo e($piddata->id); ?> inputItem" name="inputItem">
																					<?php echo e($piddata->description); ?>

																				</td>
																				<td style="width:7.14%" class="batch_item<?php echo e($piddata->id); ?> inputLocation" name="inputLocation">
																					<?php echo e($piddata->location); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputwhs100" name="inputWhs100" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->whs100); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputwhs102" name="inputWhs102" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->whs102); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputwhsnon" name="inputWhsnon" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->whsnon); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputwhssm" name="inputWhssm" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->whssm); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputwhsng" name="inputWhsng" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->whsng); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputInventoryQty" name="inputInventoryQty" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->inventory_qty); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputActualQty" name="inputActualQty" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->actual_qty); ?>

																				</td>
																				<td class="batch_item<?php echo e($piddata->id); ?> inputVariance" name="inputVariance" style="width:7.14%;text-align: right;">
																					<?php echo e($piddata->variance); ?>

																				</td>
																				<td style="width:7.14%" class="batch_item<?php echo e($piddata->id); ?> inputRemarks" name="inputRemarks">
