                        ...
                        <tr>
                            <td width="50%">
                                ...
                                <div class="form-group" id="app_time_div">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" data-format="hh:mm A" value="<?php echo e(date('h:i A')); ?>" class="form-control enter input-sm validate clear" name="app_time" id="app_time"/>
                                        <span class="help-block">
                        ...
                        <tr>
                            <td width="50%">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control input-sm" id="inspector" name="inspector" readonly value="<?php echo e(Auth::user()->firstname); ?>" />
                                    </div>
                                </div>
