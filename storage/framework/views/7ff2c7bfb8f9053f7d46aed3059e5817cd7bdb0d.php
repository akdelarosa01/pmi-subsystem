								...
								<form method="POST" action="<?php echo e(url('/readfile')); ?>" class="form-horizontal" enctype="multipart/form-data" id="formReadfile">
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-2">
												<a href="javascript:;" id="calculate" class="btn yellow pull-right btn-md" <?php echo e($state); ?>>
		...
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="javascript:;" id="btn_pdf_overdelivery" class="btn green pull-right btn-sm">Over Delivery</a>
					<a href="javascript:;" id="btn_excel_unitcost" class="btn purple pull-right btn-sm">Unit Cost Difference</a>
					<a href="javascript:;" id="btn_excel_variance" class="btn blue pull-right btn-sm">Generate Variances</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="openNonVarianceModal" class="modal fade">
		<div class="modal-dialog modal-sm">
			<div class="modal-content ">
				...
				<div class="modal-footer">
					<a href="javascript:;" id="btn_csv_nonvariance" class="btn btn-sm blue pull-right">Generate File</a>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	$( document ).ready(function(e) {
		$('#btn_excel_variance').on('click', function(){
			window.location.href = "<?php echo e(url('/varianceexcel')); ?>";
		});
