						...
						<div class="col-sm-12">
							<form method="POST" class="form-horizontal" id="wbsfrmsml">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control input-sm" id="val" name="val" maxlength="100" >
										<div id="er3"></div>
									</div>
...
<script type="text/javascript">
	...
	function deleteAllcheckeditems(){
		...
		$.ajax({
			url: "<?php echo e(url('/deleteAll-plsetting')); ?>",
			method: 'get',
			data:  { 
				tray : tray, 
				traycount : traycount
			...
			/*console.log(data);*/
			window.location.href = "<?php echo e(url('/plsetting')); ?>";   
		}).fail(function(jqXHR, textStatus, errorThrown) {
	...
	function Add_Records(){
		...
		if(action == 'ADD')
		{
			...
			$.post("<?php echo e(url('/add-plsetting')); ?>", 
			{
		...
		{
			$.post("<?php echo e(url('/update-plsetting')); ?>", 
			{
				_token : $('meta[name=csrf-token]').attr('content')
				, data : myData
			}).done(function(data, textStatus, jqXHR){
