...
<script language="javascript" type="text/javascript">
          ...
          */
          $( document ).ready(function(e)
          {
               $("#receivingno").keyup(function(event){
                    ...
                    if(event.keyCode == 13)
                    {
                         window.location.href= "<?php echo e(url('/wbspartsreceiving?page=')); ?>" + 'PR&id=' + mat;
                    }
               });
          ...
          function getrecord(val)
          {
            ...
            window.location.href= "<?php echo e(url('/wbspartsreceiving?page=')); ?>" + val + '&id=' + id;
       }
          ...
          if($("#shipno").val() != $("#hdnshipno").val())
          {
               ...
               if(is_valid)
               {
                    ...
                    switch(action)
                    {
                         case ('ADD'):
                              ...
                              $.post("<?php echo e(url('/wbspat-save')); ?>",
                              {
                              ...
                              .done(function(data)
                              {
                                   ...
                                   window.location.href= "<?php echo e(url('/wbspartsreceiving?page=')); ?>" + 'MAX&id=-1';
                              })
                              .fail(function()
                              {
                                   $('#loading').modal('toggle');
                              ...
                              case('EDIT'):
                              $.post("<?php echo e(url('/wbspat-update')); ?>",
                              {
                                   _token              : $('meta[name=csrf-token]').attr('content')
                                   , pr_arr            : pr_arr
                                   , itemno_arr        : itemno_arr
                              ...
                              .done(function(data)
                              {
                                   ...
                                   window.location.href= "<?php echo e(url('/wbspartsreceiving?page=')); ?>" + 'CUR&id=' + $('#recid').val();
                              })
                              .fail(function()
                              {
                                   $('#loading').modal('toggle');
               ...
               switch(action)
               {
                    ...
                    case ('PRNT'):
                         ...
                         case ('DIS'):
                         window.location.href= "<?php echo e(url('/wbspartsreceiving?page=')); ?>" + 'MIN&id=1';
      ...
      function filterData(action)
      {
          ...
          $.post("<?php echo e(url('/wbspat-search')); ?>",
          {
               _token         : $('meta[name=csrf-token]').attr('content')
     ...
     {
          window.location.href= "<?php echo e(url('/wbspartsreceiving?page=')); ?>" + 'CUR&id=' + id;
     }

     function generateMrReport()
     {
          window.open("<?php echo e(url('/wbspat-report?')); ?>" + 'id=' + $("#recid").val(), '_blank');
     }

     function generateIqcReport()
     {
          window.open("<?php echo e(url('/wbspat-iqc-report?')); ?>" + 'id=' + $("#recid").val(), '_blank');
     }
									...
									<div class="col-xs-12 hidden-md hidden-lg hidden-xl">
										<div class="btn-group pull-right">
											<button aria-expanded="false" class="btn green btn-block dropdown-toggle" type="button" data-toggle="dropdown">
												Parts Receiving <i class="fa fa-angle-down"></i>
											</button>
								...
								<div class="row">
									<div class="col-lg-2 col-md-2 hidden-xs hidden-sm">
										<div class="list-group">
										   ...
										   <a href="<?php echo e(url('/wbspartsreceiving')); ?>" class="list-group-item active">
											   <i class="glyphicon glyphicon-copy fa-2x"></i> Parts Receiving
										   </a>
 ...
 <div class="tab-content" id="tab-subcontents">
  <div class="tab-pane fade in active" id="details">
   <div class="row">
    ...
    <tbody>
     <?php if(isset($pr_details_data)): ?>
     <?php foreach($pr_details_data as $prddata): ?>
     <tr>
      <td><?php echo e($prddata->item); ?></td>
      <td><?php echo e($prddata->description); ?></td>
      <td style="text-align: right"><?php echo e($prddata->qty); ?></td>
      <td><?php echo e($prddata->lot_no); ?></td>
      <td><?php echo e($prddata->pr); ?></td>
      <td><?php echo e($prddata->drawing_no); ?></td>
    </tr>
    <?php endforeach; ?>
    <?php endif; ?>
  </tbody>
...
<div class="tab-pane fade" id="summary">
 <div class="row">
  ...
  <tbody>
   <?php $iqc = 0?>
   <?php if(isset($pr_summary_data)): ?>
   <?php foreach($pr_summary_data as $prsdata): ?>
   <tr class="odd gradeX" data-id="<?php echo e($prsdata->id); ?>">
    <td style="font-size:10px"><?php echo e($prsdata->item); ?></td>
    <td style="font-size:10px"><?php echo e($prsdata->description); ?></td>
    <td style="text-align: right; font-size:10px"><?php echo e($prsdata->qty); ?></td>
    <td style="text-align: right; font-size:10px"><?php echo e($prsdata->r_qty); ?></td>
    <td style="text-align: right; font-size:10px"><?php echo e($prsdata->variance); ?></td>
  </tr>
  <?php endforeach; ?>
  <?php endif; ?>
</tbody>
...
<div class="tab-pane fade" id="batch">
 ...
 <tbody id="table_body" >
   <?php $ctr = 1; ?>
   <?php if(isset($pr_batch_data)): ?>
   <?php foreach($pr_batch_data as $prbdata): ?>
   <tr id="tr_batch_item<?php echo $ctr; ?>">
    ...
    <td class="batch_item<?php echo $ctr; ?> inputItemNo" name="inputItemNo"> <?php echo e($prbdata->item); ?> </td>
    <td class="batch_item<?php echo $ctr; ?> inputItem" name="inputItem"> <?php echo e($prbdata->description); ?> </td>
    <td class="batch_item<?php echo $ctr; ?> inputQty" name="inputQty"> <?php echo e($prbdata->qty); ?> </td>
    <td class="batch_item<?php echo $ctr; ?> inputBoxQty" name="inputBoxQty"> <?php echo e($prbdata->box_qty); ?> </td>
    <td class="batch_item<?php echo $ctr; ?> inputLotNo" name="inputLotNo"> <?php echo e($prbdata->lot_no); ?> </td>
    <td class="batch_item<?php echo $ctr; ?> inputLocation" name="inputLocation"> <?php echo e($prbdata->location); ?> </td>
    <td class="batch_item<?php echo $ctr; ?> inputIsPrinted" name="inputIsPrinted"><input type="checkbox" class="isprinted<?php echo $ctr; ?>" disabled value="<?php echo e($prbdata->is_printed); ?>" <?php if(isset($prbdata->is_printed)){if($prbdata->is_printed == 1){ echo 'checked';}} ?>/></td>
    <td>
     <button type="button" style="font-size:12px; <?php if(isset($prdata)){ if($prdata->status == 'Cancelled') { echo 'display:none;'; } } ?>" onclick="javascript: setcontrol('PRNT', '<?php echo e($prbdata->item); ?>|<?php echo e($prbdata->is_printed); ?>');" class="btn grey-gallery input-sm" <?php echo $state; ?> ><i class="fa fa-barcode"></i></button>
   </td>
 </tr>
 <?php $ctr ++; ?>
 <?php endforeach; ?>
...
<form>
 ...
 <div class="row">
  ...
  <button type="submit" style="font-size:12px; <?php if(isset($prdata)){ if($prdata->status == 'Cancelled') { echo 'display:none;'; } } ?> <?php if($action!='VIEW'){ echo 'display:none;'; } ?>" formtarget="_blank" onclick="javascript: generateMrReport();" class="btn purple-plum input-sm" id="btn_print" <?php echo($state); ?>>
...
<div id="deleteModal" class="modal fade" role="dialog">
 <div class="modal-dialog modal-sm blue">
  <form role="form" method="POST" action="<?php echo e(url('/wbspat-cancel')); ?>">
   <div class="modal-content ">
    <div class="modal-body">
...
<div id="barcodeModal" class="modal fade" role="dialog">
 <div class="modal-dialog modal-sm blue">
  <form role="form" method="POST" action="<?php echo e(url('/wbspat-barcode')); ?>">
   <div class="modal-content ">
    <div class="modal-body">
...
<div id="searchModal" class="modal fade" role="dialog">
 <div class="modal-dialog modal-lg">
  ...
  <!-- Modal content-->
  <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/wbspartsreceiving')); ?>">
   <?php echo csrf_field(); ?>
