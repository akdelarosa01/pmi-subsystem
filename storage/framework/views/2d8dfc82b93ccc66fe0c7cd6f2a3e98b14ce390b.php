...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/bootstrap-tagsinput-latest/bootstrap-tagsinput.css')); ?>"/>
	...
	<?php /* <link id="style_color" href="<?php echo e(asset('assets/admin/layout/css/themes/light.css')); ?>" rel="stylesheet" type="text/css"/> */ ?>
...
<body class="page-md page-header-fixed page-quick-sidebar-over-content page-style-square page-container-bg-solid"><?php /* page-md page-header-fixed page-quick-sidebar-over-content page-full-width */ ?>
	...
	<?php /* <script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js')); ?>"></script> */ ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/bootstrap-tagsinput-latest/bootstrap-tagsinput.js')); ?>"></script>
	...
	<?php /* <script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/typeahead/handlebars.min.js')); ?>"></script>
	...
	<?php /* <script src="<?php echo e(asset('assets/global/plugins/jstree/dist/jstree.min.js')); ?>"></script> */ ?>
	...
	<?php /* <script src="<?php echo e(asset('assets/global/scripts/datetime.js')); ?>" type="text/javascript"></script> */ ?>
	...
	<?php /* <script src="<?php echo e(asset('assets/global/plugins/jquery-file-upload/blueimp-gallery/jquery.blueimp-gallery.min.js')); ?>"></script> */ ?>
	<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
	<?php /* <script src="<?php echo e(asset('assets/global/plugins/jquery-file-upload/js/jquery.iframe-transport.js')); ?>"></script> */ ?>

	<!-- The basic File Upload plugin -->
	<?php /* <script src="<?php echo e(asset('assets/global/plugins/jquery-file-upload/js/jquery.fileupload.js')); ?>"></script> */ ?>
	<script src="<?php echo e(asset('assets/admin/pages/scripts/table-editable.js')); ?>"></script>
	<?php /* <script src="<?php echo e(asset('assets/global/plugins/progressbar/dist/js/jquery.progresstimer.js')); ?>"></script> */ ?>
