									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="btn-group pull-right">
												<button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-success btn-lg" <?php echo($state); ?> id="btn_add_user" ><i class="fa fa-plus-square-o"></i> ADD</button>
												<a href="#" id="editbtn" class="btn btn-primary btn-lg"><i class="fa fa-edit"></i> EDIT</a><!---->
												<a href="#" id="delbtn" class="btn btn-danger btn-lg" <?php echo($state); ?> ><i class="fa fa-trash-o"></i> DELETE</a><!--data-toggle="modal" data-target="#deleteModal"-->
