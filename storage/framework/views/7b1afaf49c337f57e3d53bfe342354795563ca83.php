...
<script type="text/javascript" src="<?php echo e(asset('assets/global/plugins/canvasjs.min.js')); ?>"></script>
<script>
     ...
     /*    alert(data[0]['toutput']);
         var treject =data[0]['treject'];*/
          ...
          for(var i = 0; i < data.length; i++)
          {
               ...
               chart.options.data[1].dataPoints.push({label: data[i].family, y: parseInt(data[i]['treject'])});
               chart.render();
          }
