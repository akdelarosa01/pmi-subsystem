                              ...
                              <div class="row">
                                   <div class="col-sm-3">
                                       ...
                                       <?php /*  <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                             <div class="col-sm-12">
                                              <?php /*     <button type="button" style="font-size:10px;" onclick="javascript:deleteAllcheckeditems();" class="btn  red remove-task" id="btnremove_detail"> */ ?>
                                             ...
                                             <thead >
                                                  <tr>
                                                       <td class="table-checkbox" style="width: 5%">
                                                           <?php /*  <input type="checkbox" class="group-checkable checkAllitems" name="checkAllitem" data-set="#tbl_yield .checkboxes"/> */ ?>
                                                       </td>
                                                      <?php /*  <td>
                                                       </td> */ ?>
                                                       <td>PO Number</td>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control input-sm" id="deviceptype" name="deviceptype" tabindex="5">
                                                     <option value=""></option>
                                                    <?php /*  <option value="Test Socket">Test Socket</option>
                              ...
                              <div class="col-sm-12">
                                   <table id="tbl_poregistration" class="table table-striped table-bordered table-hover"style="font-size:13px">
                                        <thead id="thead1">
                                             <tr>
                                                 <td class="table-checkbox" style="width: 5%">
                                                       <?php /* <input type="checkbox" class="group-checkable checkAllitemspo" name="checkAllitempo"/>       */ ?>
                                                  </td>
                                                  <td></td>
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control input-sm" id="Seriesfamily" name="Seriesfamily">
                                                      ...
                                                      <?php /*  <option value="BGA">BGA</option>
...
<?php /* <script type="text/javascript" src="<?php echo e(asset(Config::get('constants.PUBLIC_PATH').'assets/global/plugins/canvasjs.min.js')); ?>"></script> */ ?>
...
$(document).ready(function(e) {
     ...
     ButtonsClear();
     //ButtonClosed();
     getDatatable('tbl_yield',"<?php echo e(url('/getYieldPerformanceDT')); ?>",dataColumnYIELD,[],0);
...
function poregistration(){
     ...
     //CER
     jQuery.ajax({
          url: "<?php echo e(url('/CheckYpicsPO')); ?>",
          type: 'GET',
          dataType: 'json',
          data: {_token: "<?php echo e(Session::token()); ?>", po: pono},
          success: function(returnData) {
               if(returnData > 0 && status == "ADD")
               {
                    ...
                    jQuery.ajax({
                         url: "<?php echo e(url('/add-poregistration')); ?>",
                         type: 'POST',
                         dataType: 'json',
                         ...
                         success:function(returnData){
                                        if(status == "ADD"){
                                             ...
                                             getDatatable('tbl_poregistration',"<?php echo e(url('/get-poregistration')); ?>",dataColumn,[],0);
                                        }
                                        else{
...
function seriesregistration(){
     ...
     jQuery.ajax({
          url: "<?php echo e(url('/add-seriesregistration')); ?>",
          type: 'POST',
          dataType: 'json',
          data: {_token: "<?php echo e(Session::token()); ?>", 
                    id:id,
          ...
          success:function(returnData){
                         if(STATUS == "ADD"){
                              ...
                              getDatatable('tbl_seriesregtable',"<?php echo e(url('/get-seriesregistration')); ?>",dataColumnseries,[],0);
                         }
                         else{
...
function modregistration(){
     ...
     jQuery.ajax({
               url: "<?php echo e(url('/add-modregistration')); ?>",
               type: 'POST',
               dataType: 'json',
               data: {_token: "<?php echo e(Session::token()); ?>", 
                         id:id,
               ...
               success:function(returnData){
                              if(STATUS == "ADD"){
                                   ...
                                   getDatatable('tbl_MODtable',"<?php echo e(url('/getModofDef')); ?>",dataColumnMOD,[],0);
                              }
                              else{
...
function targetregistration(){
     ...
     $('#tblfortarget').html("");
     jQuery.ajax({
          url: "<?php echo e(url('/add-targetreg')); ?>",
          type: 'POST',
          dataType: 'json',
          data: {_token: "<?php echo e(Session::token()); ?>", 
                    datefrom:datefrom,
          ...
          success:function(returnData){
                         if(STATUS == "ADD"){
                              ...
                              getDatatable('modreg-table',"<?php echo e(url('/getTargetYield')); ?>",dataColumnYieldTarget,[],0);
                         }
                         else{
...
function removeporeg(){
     ...
     $('#tblforporeg').html("");
     $.ajax({
          url: "<?php echo e(url('/deleteporeg')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
...
function removeYIELD(){
     ...
     var traycount =tray.length;
     $.ajax({
          url: "<?php echo e(url('/deleteYIELD')); ?>",
          method: 'get',
          data:  { 
               tray : tray, 
               traycount : traycount
...
function getFamilyList(s){
   var select = $('#'+s);
   $.ajax({
          url: "<?php echo e(url('/getFamilyDropDown')); ?>",
          type: "get",
          dataType: "json",
          success: function (returndata) {
               select.empty();
...
function getSeriesList(){
   ...
   $.ajax({
          url: "<?php echo e(url('/getSeriesDropdown')); ?>",
          type: "get",
          dataType: "json",
          success: function (returndata) {
               select.empty();
...
function getProductList(){
   ...
   $.ajax({
          url: "<?php echo e(url('/getProdtypeDropdown')); ?>",
          type: "get",
          dataType: "json",
          success: function (returndata) {
               select.empty();
