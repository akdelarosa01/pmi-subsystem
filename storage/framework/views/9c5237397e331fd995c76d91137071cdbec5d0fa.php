						...
						<div class="col-md-12">
							<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/packinglistsystem-printpdf')); ?>" target="_blank" id="print_form">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" name="top" class="form-control" placeholder="Ex: 0.5 / 1.0 / 1.5 / etc." value="1.5">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3">Right</label>
									<div class="col-sm-9">
										<input type="text" name="right" class="form-control" placeholder="Ex: 0.5 / 1.0 / 1.5 / etc." value="1">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3">Bottom</label>
									<div class="col-sm-9">
										<input type="text" name="bottom" class="form-control" placeholder="Ex: 0.5 / 1.0 / 1.5 / etc." value="1">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-3">Left</label>
									<div class="col-sm-9">
										<input type="text" name="left" class="form-control" placeholder="Ex: 0.5 / 1.0 / 1.5 / etc." value="1">
									</div>
								</div>
