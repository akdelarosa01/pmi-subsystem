...
<?php $__env->startSection('content'); ?>
	...
	<?php foreach($userProgramAccess as $access): ?>
		<?php if($access->program_code == Config::get('constants.MODULE_CODE_PCKNGMLD')): ?>  <!-- Please update "2001" depending on the corresponding program_code -->
...
$(function() {
    ...
    $('#btn_runcard').on('click', function() {
        ...
        $('#tblforruncard').html("");
        $.ajax({
            url:"<?php echo e(url('/displayMOLDING_runcard')); ?>",
            method:'get',
            data:myData,
            ...
            $.each(data,function(i,val){
                ...
                $('.rcedit-task').on('click', function(e) {
                    ...
                    $.ajax({
                        url:"<?php echo e(url('/packingMOLDING_runcard_edit')); ?>",
                        method:'get',
                        data:{
                            id:editid
                        }
    ...
    $('.rcedit-task').on('click', function(e) {
        ...
        var editid = edittext[0];
        $.ajax({
            url:"<?php echo e(url('/rcpackingMOLDINGEdit')); ?>",
            method:'get',
            data:{
                id:editid
            }
    ...
    $('#po_no').on('change',function(){
        var pono = $('#po_no').val();
        $.ajax({
            url:"<?php echo e(url('/getpackingMOLDINGYPICSrecords')); ?>",
            method:'get',
            data:{
                pono:pono
            },
        ...
        $.ajax({
            url:"<?php echo e(url('/getTotalMOLDINGmod')); ?>",
            method:'get',
            data:{
                pono:pono
            },
    ...
    $('#carton_no').focusout(function(){
        ...
        var cartonno = $('#carton_no').val();
        $.ajax({
            url:"<?php echo e(url('/getTotalMOLDINGruncard')); ?>",
            method:'get',
            data:{
                pono:pono,
                cartonno:cartonno
    ...
    $('#btn_pdf').on('click', function() {
        ...
        var url = "<?php echo e(url('/packingMOLDINGprintreport?data=')); ?>" + encodeURIComponent(JSON.stringify(tableData));
    ...
    $('#btn_excel').on('click', function(){
        ...
        var url = "<?php echo e(url('/packingMOLDINGprintreportexcel?data=')); ?>" + encodeURIComponent(JSON.stringify(tableData));
        window.location.href= url;
    });
    ...
    $('#group1').on('change',function(){
        ...
        $('#group1content').html("");
        $('#tblforpacking').html("");
        $.post("<?php echo e(url('/packingMOLDINGselectgroupby1')); ?>",
        {
    ...
    $('.edit-taskinspection').on('click',function(){
        ...
        var id = field[0];
        $.ajax({
            url:"<?php echo e(url('/packMOLDINGmod_edit')); ?>",
            method:'get',
            data:{
                id:id
            },
...
function totalquantity() {
    ...
    var cartonno = $('#carton_no').val();
    $.ajax({
        url:"<?php echo e(url('/getMOLDINGlot')); ?>",
        method:'get',
        data:{
            pono:pono,
            cartonno:cartonno
...
function totalmod() {
    var pono = $('#po_no').val();
    $.ajax({
        url:"<?php echo e(url('/getMOLDINGmod')); ?>",
        method:'get',
        data:{
            pono:pono
        },
...
function packingsave(){
    ...
    $.post("<?php echo e(url('/packingMOLDINGSave')); ?>",
    {
        _token:$('meta[name=csrf-token]').attr('content'),
        data:myData
    }).done(function(data, textStatus, jqXHR){
...
function rc_save(){
    ...
    $.post("<?php echo e(url('/packingMOLDING_runcard_Save')); ?>",
    {
        _token:$('meta[name=csrf-token]').attr('content'),
        data:myData
    }).done(function(data, textStatus, jqXHR){
...
function packingDelete(){
    ...
    $.ajax({
            url:"<?php echo e(url('/packingMOLDINGDelete')); ?>",
            method:'get',
            data:myData
...
function rcpackingDelete(){
    ...
    $('#tblforruncard').html("");
    $.ajax({
            url:"<?php echo e(url('/rcpackingMOLDINGDelete')); ?>",
            method:'get',
            data:myData            
    }).done(function(data, textStatus, jqXHR){
        console.log(data);
...
function groupby(){
    ...
    $('#tblforpacking').html("");
    $.post("<?php echo e(url('/packingMOLDINGdbgroupby')); ?>",
    {
        _token:$('meta[name=csrf-token]').attr('content'),
        data:myData
...
function searchby(){
   ...
   /* if(tempdatefrom == ""){     
    ...
    $('#tblforpacking').html("");
    $.get("<?php echo e(url('/packingMOLDINGsearchby')); ?>",
    {
        _token:$('meta[name=csrf-token]').attr('content'),
        datefrom:datefrom,
        dateto:dateto,
...
function display_packmod(){
    ...
    $.ajax({
        url:"<?php echo e(url('/displayMOLDINGpackmod')); ?>",
        method:'get',
        data:{
            pono:pono,
        },
...
function packmod_save(){
    ...
    $('#tblformodinspection').html("");
    $.post("<?php echo e(url('/packMOLDINGmod_save')); ?>",
    {
        _token:$('meta[name=csrf-token]').attr('content'),
        mod:mod,
        qty:qty,
...
function deleteAllcheckedinspection(){
    ...
    $('#tblformodinspection').html("");
    $.ajax({
            url:"<?php echo e(url('/packMOLDINGmod_delete')); ?>",
            method:'get',
            data:myData            
    }).done(function(data, textStatus, jqXHR){
        console.log(data);
...
function loadPackdata(){
    $.get("<?php echo e(url('/packmoldgetrows')); ?>",
    {
        _token:$('meta[name=csrf-token]').attr('content')
    }).done(function(data, textStatus, jqXHR){
        console.log(data);
