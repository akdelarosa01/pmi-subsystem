                              ...
                              <div class="col-sm-12">
                                   <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                             <label class="control-label col-sm-3">PO Number</label>
                                             <div class="col-sm-9">
                                                  <input type="text" class="form-control input-sm" id="devicepono" name="devicepono">
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <input type="text" class="form-control input-sm" id="devicename" name="devicename">
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control select2me input-sm" id="devicefamily" name="devicefamily">
                                                     <option value=""></option>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control select2me input-sm" id="deviceseries" name="deviceseries">
                                                     <option value=""></option>
                                                     <?php foreach($series as $ys): ?>
                                                         <option value="<?php echo e($ys->description); ?>"><?php echo e($ys->description); ?>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control select2me input-sm" id="deviceptype" name="deviceptype">
                                                     <option value=""></option>
                                                     <?php foreach($ptype as $ys): ?>
                                                         <option value="<?php echo e($ys->description); ?>"><?php echo e($ys->description); ?>
                              ...
                              <div class="col-sm-12">
                                   ...
                                   <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group">
                                             <label class="control-label col-sm-3">Series</label>
                                             <div class="col-sm-9">
                                                  <Select class="form-control select2me input-sm" id="seriesname" name="seriesname">
                                                     <option value=""></option>
                                                     <?php foreach($series as $ys): ?>
                                                         <option value="<?php echo e($ys->description); ?>"><?php echo e($ys->description); ?>
                               ...
                               <div class="col-sm-12">
                                   ...
                                   <?php echo csrf_field(); ?>
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control select2me input-sm" id="mod" name="mod">
                                                     <option value=""></option>
                                                     <?php foreach($modefect as $ys): ?>
                                                         <option value="<?php echo e($ys->description); ?>"><?php echo e($ys->description); ?>
                              ...
                              <div class="col-sm-12">
                                   <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                             <label class="control-label col-sm-3">PO Quantity</label>
                                             <div class="col-sm-9">
                                                  <select class="form-control input-sm" name="dsr-poqty" id="dsr-poqty">
                                                       <option value=""></option>
                                                       <?php foreach($record as $rec): ?>
                                                       <option value="<?php echo e($rec->poqty); ?>"><?php echo e($rec->poqty); ?></option>
                                                       <?php endforeach; ?>
                                                  </select>
                                             </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                             <div class="col-sm-9">
                                                  <input type="checkbox" value="IC SOCKET" class="form-control input-sm" id="dsr-icsocket" name="dsr-icsocket">IC-Socket
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <div class="col-sm-9">
                                                  <input type="checkbox" value="FOL" class="form-control input-sm" id="dsr-fol" name="dsr-fol" >FOL
                                             </div>
                                        </div>
                                        <div class="form-group pull-right">
                                             <div class="col-sm-12">
                                                  <button type="button" onclick="javascript:defectsummaryRpt();"  class="btn green-jungle input-sm">Export to Excel</button>
                                                  <button type="button" class="btn yellow-gold input-sm" >Export to PDF</button> 
                                   ...
                                   <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control input-sm" id="srprodtype" name="srprodtype">
                                                     <option></option>
                                                     <?php foreach($prodDest as $dest): ?>
                                                     <option value="<?php echo e($dest->description); ?>"><?php echo e($dest->description); ?></option>
                                                     <?php endforeach; ?>
                                                 </Select>
                                             </div>     
                                        </div>
                                        ...
                                        <div class="form-group pull-right">
                                             <div class="col-sm-12">
                                                  ...
                                                  <button type="button"  onclick="javascript:summaryRptPdf();" class="btn yellow-gold input-sm" >Export to PDF</button> 
                                                   <button type="button" data-dismiss="modal" class="btn btn-danger input-sm">Close</button>
                                             </div>  
                                        </div>
                                   </form>   
                              ...
                              <div class="col-sm-12">
                                   <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control input-sm " id="ypsr-seriesname" name="ypsr-seriesname">
                                                       ...
                                                       <option value="<?php echo e($serie->description); ?>"><?php echo e($serie->description); ?></option>
                                                       <?php endforeach; ?>
                                                 </Select>
                                             </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                             <label class="control-label col-sm-3">PO Number</label>
                                             <div class="col-sm-9">
                                                  <Select class="form-control input-sm " id="ypsr-ponumber" name="ypsr-ponumber">
                                                       <option></option>
                                                       <?php foreach($record as $rec): ?>
                                                       <option value="<?php echo e($rec->pono); ?>"><?php echo e($rec->pono); ?></option>
                                                       <?php endforeach; ?>
                                                 </Select>
                                             </div>
                                        </div>
                         ...
                         <div class="row">
                              <div class="col-sm-12">
                                   <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <div class="col-sm-9">
                                                  <Select class="form-control input-sm " id="ysf-yieldtarget" name="ysf-yieldtarget">
                                                       <option></option>
                                                       <?php foreach($record as $rec): ?>
                                                       <option value="<?php echo e($rec->yieldingstation); ?>"><?php echo e($rec->yieldingstation); ?></option>
                                                       <?php endforeach; ?>
                                                  </Select>
                                        ...
                                        <div class="form-group">
                                             <div class="col-sm-9">
                                                  <input type="checkbox" class="form-control input-sm" id="ysf-icsocket" name="ysf-icsocket">IC-Socket
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <div class="col-sm-9">
                                                  <input type="checkbox" class="form-control input-sm" id="ysf-fol" name="ysf-fol">FOL
                                             </div>
                                        </div>
                                        <div class="form-group pull-right">
                                             <div class="col-sm-12">
...
<script src="assets/global/plugins/canvasjs.min.js"></script>
<script>
...
function loadchart(){
     ...
     chart.options.data[0].dataPoints.push({label: data[i].family, y: data[i].toutput});
     chart.render();
     }
     for(var i = 0; i < data.length; i++)
     {
     var length = chart.options.data[1].dataPoints.length;
     chart.options.data[1].dataPoints.push({label: data[i].family, y: data[i].treject});
     chart.render();
     }
          ...
          $.each(data,function(i,val){
               ...
               $('.edit-seriesreg').click(function(){
                    ...
                    $.ajax({
                         ...
                         $('#seriesname').select2('val',data[0]['series']);  
                    }).fail(function(jqXHR, textStatus, errorThrown) {
                         console.log(errorThrown+'|'+textStatus);
                    });
               });
...
function targetregistration(){
     var srdatefrom = $('#target-datefrom').val();
     var srdateto = $('#target-dateto').val();
...
function summaryREpt(){
     ...
     window.location = "<?php echo e(url('/summaryREpt')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&srprodtype=" + srprodtype + "&&srfamily=" + srfamily;
}
function summaryRptPdf(){
     var srdatefrom = $('#srdatefrom').val();
     var srdateto = $('#srdateto').val();
     var srprodtype = $('#srprodtype').val();
     var srfamily = $('#srfamily').val();
     ...
     var dateto = paramto[2]+'-'+paramto[0]+'-'+paramto[1];
     $.ajax({
          url: "<?php echo e(url('/summaryRptPdf')); ?>",
          method: 'get',
          data:  {
               _token : token,
               datefrom : srdatefrom, 
          ...
          window.location = "<?php echo e(url('/summaryRptPdf')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&srprodtype=" + srprodtype + "&&srfamily=" + srfamily;
     }).fail(function(jqXHR, textStatus, errorThrown) {
          console.log(errorThrown+'|'+textStatus);
     });
}
function defectsummaryRpt(){
     ...
     window.location = "<?php echo e(url('/defectsummaryRpt')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&poqty=" + poqty + "&&option=" + option;
}
...
function yieldsumfamRpt(){
     ...
     window.location = "<?php echo e(url('/yieldsumfamRpt')); ?>" + "?_token=" + token + "&&datefrom=" + datefrom + "&&dateto=" + dateto + "&&chosen=" + chose;

     $.ajax({
          url: "<?php echo e(url('/yieldsumRpt')); ?>",
          method: 'get',
          data:  {
