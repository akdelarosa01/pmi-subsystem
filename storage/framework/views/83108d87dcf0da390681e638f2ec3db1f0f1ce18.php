		...
		function loadforIQC(url) {
            ...
            $('#tbl_iqc').DataTable({
                ...
                columns: [
                    ...
                    },orderable: false, searchable:false, name:"b.id" },
                    { data: 'item', name: 'b.item' },
                    { data: 'item_desc', name: 'b.item_desc' },
                    { data: 'supplier', name: 'b.supplier' },
                    { data: 'qty', name: 'b.qty' },
                    { data: 'lot_no', name: 'b.lot_no' },
                    { data: 'drawing_num', name: 'b.drawing_num' },
                    { data: 'wbs_mr_id', name: 'b.wbs_mr_id' },
                    { data: 'invoice_no', name: 'b.invoice_no' },
                    { data: 'app_by', name: 'r.app_by' },
                    { data: 'app_date', name: 'r.app_date'},
                    { data: 'ins_by', name: 'b.ins_by' },
                    { data: 'ins_date', name: 'b.ins_date'},
                    { "data": function(data){
                        return data.iqc_status;
                    }, "name":"b.iqc_status" },
                    { data: 'iqc_result', name: 'b.iqc_result' },
