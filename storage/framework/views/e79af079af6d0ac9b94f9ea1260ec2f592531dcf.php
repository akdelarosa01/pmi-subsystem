                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="0" max="1" class="form-control input-sm checkifEmpty" id="accept" name="accept">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="0" max="1" class="form-control input-sm checkifEmpty" id="reject" name="reject">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control input-sm date-picker checkifEmpty" type="text" value="" name="date_inspected" id="date_inspected"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control input-sm checkifEmpty" id="inspector" name="inspector" readonly />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control input-sm checkifEmpty" id="lot_inspected" name="lot_inspected">
