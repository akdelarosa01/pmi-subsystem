                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <div class="form-group">
                                                                     ...
                                                                     <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                        <?php /*     <input class="form-control input-sm" size="16" type="text" name="poqty" value="<?php foreach($msrecords as $msrec): ?><?php echo e($msrec->POqty); ?> <?php endforeach; ?>" id="poqty"  */ ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                           <?php /*  <input type="text" class="form-control input-sm" id="device" name="device" value="<?php foreach($msrecords as $msrec): ?><?php echo e($msrec->devicename); ?><?php endforeach; ?>" disabled="disabled"/> */ ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            <Select class="form-control input-sm" id="series" name="series" required>
                                                                                <option value=""></option>
                                                                                <?php foreach($devreg as $serie): ?>
                                                                                   <option value="<?php echo e($serie->series); ?>"><?php echo e($serie->series); ?>
...
$('#family').on('change',function(){
    $ss = $('#family').val();
     $.ajax({
          url: "<?php echo e(url('/getRelatedseries')); ?>",
          type: "get",
          dataType: "json",
          data:{
            Family:$('#family').val(),
...
function searchpo(){
    ...
    if(pono == ""){
        ...
        { 
            ...
            $.ajax({
                url: "<?php echo e(url('/getautovalue')); ?>",
                method: 'get',
                data:{ 
                    pono : pono
                },      
            ...
            $('#tbody1').html("");
            $.ajax({
                url: "<?php echo e(url('/searchdisplaypya')); ?>",
                method: 'get',
                data:  { 
                    pono : pono,
                    yieldingstation:yieldingstation       
            ...
            $('#tbody2').html("");
            $.ajax({
                url: "<?php echo e(url('/searchdisplaycmq')); ?>",
                method: 'get',
                data:  { 
                    pono : pono, 
                    yieldingstation:yieldingstation      
            ...
            $('#tbldetails').html("");
            $.ajax({
                url: "<?php echo e(url('/searchdisplaydetails')); ?>",
                method: 'get',
                data:  { 
                    pono : pono,
                    yieldingstation:yieldingstation       
            ...
            $.ajax({
                url: "<?php echo e(url('/searchdisplaysummary')); ?>",
                method: 'get',
                data:  { 
                    pono : pono       
                },      
...
function GETPoDetails(){
    pono = $('#pono').val();
    jQuery.ajax({
              url: "<?php echo e(url('/GetPONumberDetails')); ?>",
              type: 'GET',
              dataType: 'json',
              data: {_token: "<?php echo e(Session::token()); ?>", po: $('#pono').val()},
              success: function(returnData) {
