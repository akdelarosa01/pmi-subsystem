        ...
        else
        {
        	...
        	else if(action == 'EDIT')
        	{
        		...
        		else
        		{
        			...
        			{
						window.location.href= "<?php echo e(url('/packinglistdetails?selecteditem=')); ?>" + selecteditem + "&dbconnection=" + $('#dbconnection').val();        			
					}
        		}
        	}
        	else
    ...
    function addDetails()
    {
        if($('#dbconnection').val() == 0)
       	...
       	{
			window.location.href= "<?php echo e(url('/packinglistdetails?dbconnection=')); ?>" + $('#dbconnection').val();
		}
    }
										...
										<div class="row">
											...
											<?php echo csrf_field(); ?>
		                                        ...
		                                        <div class="form-group">
		                                             ...
		                                             <div class="col-md-4">
		                                             	<label for="inputcode" class="col-md-4 control-label input-sm">Invoice Date</label>
		                                             ...
		                                             <div class="col-md-3">
															<div class="form-group">
																<label class="col-md-4 input-sm">Product Line</label>
																<div class="col-md-8">
																	<select name="productline" id="dbconnection" class="form-control input-sm">
																		<option selected="selected" value="0">-- Select --</option>
																		<?php if(isset($productlines)): ?>
																		<?php foreach($productlines as $productline): ?>
																		<option value="<?php echo e($productline->code); ?>" 
																			<?php if(isset($dbconnection)){if($dbconnection == $productline->code)
																			{
																				echo 'selected';
																			}}
