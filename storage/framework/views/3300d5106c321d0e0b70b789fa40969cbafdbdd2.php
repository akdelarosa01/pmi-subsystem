                                                        ...
                                                        <div class="portlet-body">
                                                                        ...
                                                                        <div class="col-sm-4">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    ...
                                                                                    <input type="text" class="form-control input-sm" id="counter" name="counter"  disabled="disabled" />
                                                                                </div>
                                                                             </div>
                                                            ...
                                                            <div class="form-group pull-right">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <input type="text" class="form-control input-sm " name="hdstatus" id="hdstatus"></input>
                                                                </div>    
                                                            </div>
                                                            <!-- Action Buttons -->
                                                            <br/>
    ...
    if(pono == ""){
        ...
        { 
            ...
            $.ajax({
                ...
                $('input[name=tmng]').val(data[0]['tmng']);    
                $('input[name=tpng]').val(data[0]['tpng']); 
                $('input[name=toutput]').val(data[0]['toutput']);
                $('#ywomng').val(data[0]['ywomng']);
                var toutput = $('#toutput').val();
                var tpng = $('#tpng').val();
                var sum = parseInt(toutput) + parseInt(tpng);
                var temp = tpng/sum;
                ...
                $.each(data, function(i,val) {
                    var tblrow = '<tr id="pya_row_'+val.id+'" class="pyarow">'+                   
                                '<td style="width: 3%">'+
                                    ...
                                    '</span>'+   
                                '</td>'+ 
                                '<td>'+val.productiondate+'<input type="hidden" value="'+val.productiondate+'" class="form-control input-sm" id="pyaproductiondate'+val.id+'" name="pyaproductiondate[]"/></td>'+
                ...
                $.each(data, function(i,val) {
                    var tblrow = '<tr id="cmq_row_'+val.id+'" class="cmqrow">'+                   
                            '<td style="width: 3%">'+
                                ...
                                '</span>'+   
                            '</td>'+ 
                            '<td>'+val.classification+'<input type="hidden"value="'+val.classification+'" class="form-control input-sm" id="cmqclassification'+val.id+'" name="cmqclassification[]"/></td>'+
