     ...
     */
     $( document ).ready(function(e)
     {
          ...
          $('#add_inputItemNo').on('change', function()
          {
               ...
               if(values.length = 3)
               {
                    ...
                    var invoice_num = $('#hdninvoiceno').val();
                    code = values[Object.keys(values)[0]];
                    // if (code < 0) {
                    //      $('#add_inputLocation').val("");
                    // } else {
                         getLocation(code,invoice_num);
                    //}
               }
     ...
     function batchdata(action)
     {
          ...
          if(action == "ADD")
          {
               ...
               {
                    $('#addbatchitem').modal('toggle');
                    $("#invalidAddBatchModal").modal('show');
               }
          }
     ...
     function getLocation(code,invoice_num)
     {
          //add_inputLocation
          var url = "<?php echo e(url('/getlocation')); ?>";
     ...
     {
          //add_invoice date
          var url = "<?php echo e(url('/getinvoicedate')); ?>";
          var token = "<?php echo e(Session::token()); ?>";
          var data = {
               _token: token,
               invoice_num: $('#invoicedate').val()
          };
          $.ajax({
               url: url,
               type: "GET",
               ...
               // });
               $('#invoicedate').val(data);
               console.log(data);
               $('#invoicedate').prop('disabled', true);
          }).fail( function(data, textStatus, jqXHR) {
               $('#msg').modal('show');
               $('#title').html('<strong><i class="fa fa-exclamation-triangle"></i></strong> Failed!');
               $('#err_msg').html("There's some error while processing invoice date.");
          });
     }
                                                       ...
                                                       <form>
                                                            ...
                                                            <div class="col-md-4">
                                                                 ...
                                                                 <div class="form-group row">
                                                                      ...
                                                                      <div class="col-md-4">
                                                                           <input class="form-control input-sm date-picker" size="16" type="text" name="invoicedate" id="invoicedate" <?php if($action=='VIEW'){ echo 'disabled'; } ?>/>
                                                                      </div>
                                                                 </div>
                                                            </div>
                                                            ...
                                                            <div class="tabbable-custom">
                                                                 ...
                                                                 <div class="tab-content" id="tab-subcontents">
                                                                      ...
                                                                      <div class="tab-pane fade" id="summary">
                                                                           <div class="row">
                                                                                <div class="col-md-8 col-md-offset-2" style="height:486px; overflow:auto;">
                                                                                     <table class="table table-striped table-bordered table-hover table-responsive" id="tbl_summary">
                                                                                          ...
                                                                                          <tbody>
                                                                                               ...
                                                                                               <tr class="odd gradeX" data-id="<?php echo e($mrsdata->id); ?>">
                                                                                                    ...
                                                                                                    <td style="font-size:10px"><input type="checkbox" class="iqc_check" name="iqc_check" <?php if($action=='VIEW'){ echo 'disabled'; } ?> value="<?php echo e($mrsdata->id); ?>" <?php if(isset($mrsdata->iqc_required )){if($mrsdata->iqc_required == 1){ echo 'checked'; }}?> <?php if($action=='ADD'): ?>
                                                                                                         <?php if($mrsdata->vendor == 'PPD' || $mrsdata->vendor == 'PPS'): ?>
                                                                                                              <?php echo e('checked'); ?>
                                                  ...
                                                  <form>
                                                       ...
                                                       <div class="row">
                                                            <div class="col-md-12 text-center">
                                                                 ...
                                                                 <button type="submit" style="font-size:12px; <?php if(isset($mrdata)){ if($mrdata->status == 'Cancelled') { echo 'display:none;'; } } ?> <?php echo($state); ?> <?php if($action!='VIEW'){ echo 'display:none;'; } ?>" onclick="javascript: generateMrReport();" class="btn purple-plum input-sm" id="btn_print">
                                                                      <i class="fa fa-print"></i> Print
                                                                 </button>
                                                                 <button type="submit"  style="font-size:12px; <?php if(isset($mrdata)){ if($mrdata->status == 'Cancelled') { echo 'display:none;'; } } ?> <?php echo($state); ?> <?php if($action!='VIEW'){ echo 'display:none;'; } ?>" onclick="javascript: generateIqcReport();" class="btn blue input-sm" id="btn_print_iqc">
                                                                           ...
                                                                           <div class="col-md-12">
                                                                                ...
                                                                                <div class="form-group">
                                                                                     ...
                                                                                     <div class="col-md-3" style="text-align: right;">
                                                                                          <label for="inputname" class="control-label" style="font-size:12px">*Package Qty</label>
                                                                                     </div>
                                                                                     <div class="col-md-2">
