...
<script type="text/javascript">
    ...
    var whsMaterialRequestPDF = "<?php echo e(url('/whs-material-request-pdf')); ?>";
    var whsServingURL = "<?php echo e(url('/wbswhsserving')); ?>";
    var getMatBcodeURL = "<?php echo e(url('/getmatbarcode')); ?>"
    var saveWhsIssuanceURL = "<?php echo e(url('/savewhsissuance')); ?>";
    var whsIssuanceCancel = "<?php echo e(url('/whsissuancecancel')); ?>";
    var whsMateIssuanceURL = "<?php echo e(url('/wbswhsmatissuance')); ?>";
    var whsExcelReport = "<?php echo e(url('/wbsWhsReport_Excel')); ?>";
    var getTotalBalanceURL = "<?php echo e(url('/gettotalbalanceqty')); ?>";
    var getsearch_viewDetailsURL = "<?php echo e(url('/getsearch_viewDetails')); ?>";
    var getmassalertURL = "<?php echo e(url('/getmassalert')); ?>";
    var viewdetailsURL = "<?php echo e(url('/viewdetails')); ?>";
    var wbswhscheckifnotcloseURL = "<?php echo e(url('/wbswhscheckifnotclose')); ?>";
    var wbswhsissuancefifotblURL = "<?php echo e(url('/wbswhsissuancefifotbl')); ?>";
    var wbswhsissuancefifotblbcURL = "<?php echo e(url('/wbswhsissuancefifotblbc')); ?>";
    var whsissuancenavURL = "<?php echo e(url('/whsissuancenav')); ?>";
    var whslatestissuanceURL =  "<?php echo e(url('/whslatestissuance')); ?>";
    var whsSearchURL = "<?php echo e(url('/wbswmi-search')); ?>";
</script>
<script src="<?php echo e(asset(config('constants.PUBLIC_PATH').'assets/global/scripts/common.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset(config('constants.PUBLIC_PATH').'assets/global/scripts/whsmaterialissuance.js')); ?>" type="text/javascript"></script>
<?php $__env->stopPush(); ?>
