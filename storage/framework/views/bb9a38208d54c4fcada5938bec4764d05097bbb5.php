 ...
 <script type="text/javascript">
 	$( document ).ready(function(e) {
				...
				if(data == '') {
					...
					$.each(data, function(i,det){
						...
						tblKitDetails = '<tr>'+
											...
											'</td>'+
											'<td>'+det.kcode+
												'<input type="hidden" id="codekit" name="codekit" value="'+det.kcode+'">'+
											'</td>'+
											'<td>'+det.partname+
												'<input type="hidden" id="partnamekit" name="partnamekit" value="'+det.partname+'">'+
											'</td>'+
											'<td>'+det.usage+
												'<input type="hidden" id="usagekit" name="usagekit" value="'+det.usage+'">'+
											'</td>'+
											'<td>'+det.rqdqty+
												'<input type="hidden" id="rqdqtykit" name="rqdqtykit" value="'+det.rqdqty+'">'+
											'</td>'+
											'<td></td>'+
											'<td>'+
											...
											'</td>'+
											'<td>'+det.drawnum+
												'<input type="hidden" id="drawnumkit" name="drawnumkit" value="'+det.drawnum+'">'+
											'</td>'+
											'<td>'+det.supplier+
						...
						itemissSelect = '<option value="'+det.kcode+'">'+det.kcode+'</option>';
		...
		$('#selectKitQtybtn').on('click', function() {
			var kitqty = parseValue($('#getkitQty').val());
			var poqty = parseValue($('#poqty').val());
