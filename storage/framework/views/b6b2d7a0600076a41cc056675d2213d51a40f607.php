								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="portlet box blue">
											...
											<div class="portlet-body">
												<form method="POST" enctype="multipart/form-data" action="<?php echo e(url('/prrs-uploadfile')); ?>" class="form-horizontal" id="readfileform">
												...
												<div class="row">
													...
													<div class="row">
														<div class="col-md-4 pull-right">
															...
															<?php if(isset($value)){ $date1=date('m/d/y'); if (strtotime($date1) <= strtotime($value->last_day)) {echo 'disabled'; }} ?>
															><i class="fa fa-edit"></i> REJECTION RATE UPDATE </button>
														</div>
													</div>
												</div>
											</div>
										...
										<div class="col-md-6">
											<div class="portlet box blue">
												...
												<div class="portlet-body">
													...
													<form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/prrs-export')); ?>">
														<div class="portlet-body">
															<?php echo csrf_field(); ?>
