                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control input-sm show-tick" name="group1content" id="group1content">
                                    <!-- append here -->
                                    </select>
                                </div> 
                            </div>  
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control input-sm show-tick" name="group2content" id="group2content">
                                    <!-- append here -->
                                    <option value=""></option>  
                                    </select>
                                </div> 
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control input-sm show-tick" name="group3content" id="group3content">
                                    <!-- append here -->
                                    </select>
                                </div>
                            </div>  
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control input-sm show-tick" name="group4content" id="group4content">
                                    <!-- append here -->
                                    </select>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control input-sm show-tick" name="group5" id="group5">
                                        <option value=""></option>
										<option value="date">Date Inspected</option>
										<option value="po_no">PO Number</option>
										<option value="device_name">Series Name</option>
                                ...
                                <div class="col-sm-5">
                                    <select class="form-control input-sm show-tick" name="group5content" id="group5content">
                                    <!-- append here -->
                                    </select>
                                </div>
                            </div>  
			...
			<div class="modal-content">
				...
				<form class="form-horizontal">
					...
					<div class="modal-footer">
						...
						<button type="button" data-dismiss="modal" class="btn btn-danger btn-sm" id="btn_search-close">Close</button>
					</div>
				</form>
			</div>
		</div>
...
$(function() {
    ...
    $('select[name=group5]').select2();
    $('select[name=group1content]').select2();
    $('select[name=group2content]').select2();
    $('select[name=group3content]').select2();
    $('select[name=group4content]').select2();
    $('select[name=group5content]').select2();
    $('#date').datepicker();
    ...
    $('#btn_pdf').on('click', function() {
        ...
        if(pono == "" && datefrom == "" && dateto == ""){
        	...
        	var url = "<?php echo e(url('/fgsprintreport?datefrom=')); ?>" + datefrom + "&dateto=" + dateto+ "&pono=" + pono;
    ...
    $('#btn_excel').on('click', function() {
        ...
        if(pono == "" && datefrom == "" && dateto == ""){
	        ...
	        var url = "<?php echo e(url('/fgsprintreportexcel?datefrom=')); ?>" + datefrom + "&dateto=" + dateto+ "&pono=" + pono;
	        window.location.href= url;
	        $('#hd_search_from').val("");
        	$('#hd_search_to').val("");
        	$('#hd_search_pono').val("");
    ...
    $('#group1').change(function(){
        ...
        $('#group1content').html("");
        $('#tblforfgs').html("");
        $.post("<?php echo e(url('/fgsdbselectgroupby1')); ?>",
        {
            ...
            $.each(data,function(i,val){
                ...
                switch(g1) {
                    case "date":
                        var sup = '<option value="'+val.date+'">'+val.date+'</option>';
                        break;
                    case "po_no":
                        var sup = '<option value="'+val.po_no+'">'+val.po_no+'</option>';
                        break;
                    case "device_name":
                        var sup = '<option value="'+val.device_name+'">'+val.device_name+'</option>';
                        break;
                    case "qty":
                        var sup = '<option value="'+val.qty+'">'+val.qty+'</option>';
                        break;
                    case "total_num_of_lots":
                        var sup = '<option value="'+val.total_num_of_lots+'">'+val.total_num_of_lots+'</option>';
                        break;
                    default:
...
function searchby(){
    ...
    var datefrom = tempdatefrom[2]+'/'+tempdatefrom[0]+'/'+tempdatefrom[1];
    var dateto = tempdateto[2]+'/'+tempdateto[0]+'/'+tempdateto[1];
    if(tempdatefrom == ""){     
