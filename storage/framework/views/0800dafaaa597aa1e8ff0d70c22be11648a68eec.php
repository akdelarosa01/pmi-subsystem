...
<?php $__env->startPush('css'); ?>
	<?php /* <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/global/plugins/datatables/extensions/Scroller/css/dataTables.scroller.min.css')); ?>"/> */ ?>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body portlet-empty">
								...
								<div class="row">
									<div class="col-md-12">
										<a href="<?php echo e(url('/mraPrint')); ?>" id="excel" class="btn green input-sm pull-right">
...
<?php $__env->startPush('script'); ?>
	<?php /* <script type="text/javascript" src="<?php echo e(asset('assets/admin/pages/scripts/table-datatables-scroller.js')); ?>"></script> */ ?>
	<script>
