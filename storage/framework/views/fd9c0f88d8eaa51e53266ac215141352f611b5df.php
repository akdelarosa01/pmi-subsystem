                            ...
                            <div class="portlet-title">
                                ...
                                <div class="actions">
                                    <div class="btn-group">
                                        ...
                                        <a target="_self" class="btn purple-plum input-sm" href="javascript: transferSlip();" id="btn_print" <?php echo($state); ?>>
                                                ...
                                                <div class="tab-pane fade" id="issuancedetails">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 text-center">
                                                            ...
                                                            <?php /* <a href="javascript:;" class="btn btn-danger input-sm" id="btn_delete_issuance_details">
                                                                <i class="fa fa-trash"></i> Delete
                                                            </a> */ ?>
                                                        </div>
                                                    </div>
