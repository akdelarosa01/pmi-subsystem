                    ...
                    <div class="col-md-offset-2 col-md-8">
                        ...
                        <div class="portlet box blue" >
                            ...
                            <div class="portlet-body">
                                <div class="row">
                                    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo e(url('/xhiki-readfile')); ?>" id="xhiki_form">
            ...
            $('xhiki_form').on('submit', function(e) {
                ...
                if (fileName != ''){
                    if (ext == 'xls' || ext == 'xlsx') {
                        ...
                        $.alert('<strong><i class="fa fa-exclamation-circle"></i> Failed!</strong> Please select a valid Excel file. This module only accepts text file.', {
                            position: ['center', [-0.42, 0]],
                            type: 'danger',
                            closeTime: 3000,
                            autoClose: true
