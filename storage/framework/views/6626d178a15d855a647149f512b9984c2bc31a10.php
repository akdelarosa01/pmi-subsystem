                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-fixedheader table-striped sortable" id="tbl_iqc" style="font-size:10px">
                                                    <thead>
                                                        <tr>
                                                            <td style="width:3.1%" class="table-checkbox">
...
<?php $__env->startPush('script'); ?>
	<script type="text/javascript">
		$(function() {
            ...
            $('#tbl_iqc_body').scroll(function() {
                if($('#tbl_iqc_body').scrollTop() + $('#tbl_iqc_body').height() >= $('#tbl_iqc_body').height()) {
                    row = row+2;
                    loadforIQC(0,row);
                }
            });
		...
		function loadforIQC(status,row) {
			//$('#loading').modal('show');
			var iqctable = '';
            	...
            	if (data.length > 0) {
            		...
            		$.each(data, function(i,x) {
	            		...
	            		iqctable = '<tr>'+
	                                    ...
	                                    '<td style="width:6.1%; background-color: '+color+'"><strong>'+status+'</strong></td>'+
	                                    '<td style="width:7.1%">'+x.iqc_result+'</td>'+
	                                    '<td style="width:7.1%">'+updated_by+'</td>'+
