											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="col-sm-8">
															<input class="form-control input-sm" type="text" name="user_id" id="user_id" value="<?php echo e($userdetails->user_id); ?>" disabled/>
														</div>
													</div>
													<div class="form-group">
														<label class="control-label col-sm-4">Password</label>
														<div class="col-sm-8">
															<input class="form-control input-sm" type="password" name="pword" id="pword" value="<?php echo e($userdetails->actual_password); ?>" disabled/>
														</div>
													</div>
													<div class="form-group">
														...
														<div class="col-sm-5">
															<select name="productline" id="productline" class="form-control input-sm">
																...
																<option value="PROBE" <?php if($userdetails->productline == 'PROBE'): ?> <?php echo e("selected"); ?><?php endif; ?>>PROBE</option>
																<option value="MOLDING" <?php if($userdetails->productline == 'MOLDING'): ?> <?php echo e("selected"); ?><?php endif; ?>>MOLDING</option>
															</select>
