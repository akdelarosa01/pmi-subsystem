...
<?php $__env->startPush('script'); ?>
	<script>
		...
		var SoldToUrl = "<?php echo e(url('/sold-to')); ?>";
		var DeleteTaskUrl = "<?php echo e(url('/delete-sold')); ?>";
		var DeleteAll = "<?php echo e(url('/deleteAll-sold')); ?>";
		var AddUrl = "<?php echo e(url('/add-sold')); ?>";
		var UpdateUrl = "<?php echo e(url('/update-sold')); ?>";
	</script>
	<script src="<?php echo e(asset(Config::get('constants.PUBLIC_PATH').'assets/global/scripts/soldto.js')); ?>" type="text/javascript"></script>
<?php $__env->stopPush(); ?>
