																...
																<tbody>
																	<?php foreach($eypprog as $eypprg): ?>
																		<tr>
																			...
																			<td>
																				<input type="checkbox" class="checkboxes rw EYPrw" name="rw[]" value="<?php echo e($eypprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																			<td>
																				<input type="checkbox" class="checkboxes r EYPr" name="r[]" value="<?php echo e($eypprg->program_code); ?>" <?php echo($state); ?> />
																			</td>
																		</tr>
																	<?php endforeach; ?>
																</tbody>
