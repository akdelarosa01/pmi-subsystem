							  ...
							  <div class="col-sm-12">
								   <form class="form-horizontal">
										...
										<div class="form-group">
											 ...
											 <div class="col-sm-9">
												  <input type="text" class="form-control input-sm date-picker" name="srdatefrom" id="srdatefrom">
											 </div>     
										</div>
										<div class="form-group">
											 <label class="control-label col-sm-3">To</label>
											 <div class="col-sm-9">
												  <input type="text" class="form-control input-sm date-picker" name="srdateto" id="srdateto">
											 </div>
										</div>
										<hr>
										<div class="form-group">
