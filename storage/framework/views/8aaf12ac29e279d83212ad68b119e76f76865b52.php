...
<?php $__env->startSection('content'); ?>
                                                                ...
                                                                <div class="col-md-12">
                                                                                            ...
                                                                                            <table class="table table-bordered table-fixedheader table-striped" style="font-size:10px">
                                                                                                <thead>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="width:20.5%;">Item Description</td>
                                                                                                        <td style="width:12.5%;">Issued Qty.(Others)</td>
                                                                    ...
                                                                    <div class="row">
																		...
																		<div class="col-md-12 text-center">
																		  ...
																		  <button type="submit" style="font-size:12px; <?php if(isset($wmdata)){ if($wmdata->status == 'Cancelled') { echo 'display:none;'; } } ?><?php if($action!='VIEW'){ echo 'display:none;'; } ?>" onclick="javascript: generateWmiReport();" class="btn purple-plum input-sm" id="btn_print" <?php echo($state); ?>  <?php echo($state); ?>>
	...
	<!-- add details -->
    <?php /* <div id="addDetModal" class="modal fade" role="dialog" data-backdrop="static">
				...
				if (data.request_status == 'failed') {
                	...
                	$.each(data.detailsdata, function(i,obj) {
						...
						tblIssuance = '<tr>'+
											...
											'</td>'+
											'<td id="issqtytd'+obj.detail_id+'">'+obj.issued_qty_t+
												'<input type="hidden" name="qtyiss[]" id="issqty'+obj.detail_id+'">'+
											'</td>'+
											'<td id="lottd'+obj.detail_id+'">'+obj.lot_no+
											...
											'<td>'+obj.location+
												...
												'<input type="text" name="id[]" value="'+obj.pmr_detail_id+'"/>'+
											'</td>'+
										'</tr>';
						$('#tblIssuance').append(tblIssuance);
						setControl('');
