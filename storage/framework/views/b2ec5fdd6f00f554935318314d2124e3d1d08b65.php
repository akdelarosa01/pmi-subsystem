			...
			<div class="modal-dialog modal-xl gray-gallery">
				<div class="modal-content ">
					...
					<div class="modal-footer">
						...
						<button type="button" data-dismiss="modal" class="btn btn-danger" id="iss_add_close">Close</button>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-dialog modal-xl gray-gallery">
				<div class="modal-content ">
					...
					<div class="modal-footer">
						...
						<button type="button" data-dismiss="modal" class="btn btn-danger" id="iss_edit_close">Close</button>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
 	$( document ).ready(function(e) {
		...
		$('#iss_add_close').click(function(){
			$('#hd_barcode').val('');
		});

		$('#iss_edit_close').click(function(){
			$('#hd_barcode').val('')
			focusbarcode();
		});
		...
		$('#tblIssDetails').on('click', '.barcodebtn', function() {
			...
			mywindow = window.open('', 'PRINT', 'height=150,width=300');
     	...
     	$.ajax({
            ...
            data: data,
     		...
     		$.each(data, function(i, x) {
     			...
     			tblfifoAdd = '<tr>'+
     							'<td style="width:8.6%">'+
     								'<a href="javascript:;" class="btn btn-primary btn_select_lot" data-lotno="'+x.lot_no+'">'+
