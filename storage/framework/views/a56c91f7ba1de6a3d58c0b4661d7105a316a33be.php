					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="row">
									<div class="col-md-12">
										<form method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data" action="<?php echo e(url('/mrp_and_r3answer')); ?>" id="formReadfile">
											<div class="form-group">
												<?php echo csrf_field(); ?>

												<label class="col-sm-4 control-label">Select MRP Data</label>
												<div class="col-sm-5">
													<input type="file" class="filestyle" data-buttonName="btn-primary" name="mrpdata" id="mrpdata" <?php echo e($readonly); ?> required>
												...
												<div class="col-sm-5">
													<input type="file" class="filestyle" data-buttonName="btn-primary" name="r3answer" id="r3answer" <?php echo e($readonly); ?> required>
								...
								<div class="row">
									<div class="col-md-12">
										<form method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data" action="<?php echo e(url('/partsanswer')); ?>" id="isogiform">
											<div class="form-group">
												<?php echo csrf_field(); ?>

												<label class="col-sm-4 control-label">Select Parts Answer Data</label>
												<div class="col-sm-5">
													<input type="file" class="filestyle" data-buttonName="btn-primary" name="partsanswerfile" id="partsanswerfile" <?php echo e($readonly); ?> required>
